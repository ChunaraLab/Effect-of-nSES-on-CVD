...
significant_mediat <- report_df %>%
  ...
  rename(ADE = b3,
         ...
         ACME = b2_b3,
         ACME_ci_lwr = b2_b3_ci_lwr,
         ACME_ci_upr = b2_b3_ci_upr,
         Total_effect = b1,
...
report_df <- data.frame(
  ...
  b4_ci_upr = numeric(),
  b2_b3 = numeric(),
  b2_b3_ci_lwr = numeric(),
  b2_b3_ci_upr = numeric(),
  stringsAsFactors = FALSE
)
...
for (combo in all_combos) {
  ...
  for (i in 1:n_boot) {
    ...
    bootstrap_results[i, 5] <- boot_coef_X_to_M[X] * boot_coef_XM_to_Y[X]
  }
  ...
  ci_b2_b3 <- quantile(bootstrap_results[, 5], c(0.025, 0.975))
  ...
  new_df <- data.frame(
    ...
    b4_ci_upr = ci_b4[2],
    b2_b3 = b2_b3,
    b2_b3_ci_lwr = ci_b2_b3[1],
    b2_b3_ci_upr = ci_b2_b3[2],
    stringsAsFactors = FALSE
  )
