...
Y <- "cvd_10y_HF"
X <- "nSES"
Z <- c("age","Diabetes","hdl","totchol","sbp","gender",
       "race","site")

# generate formula 
formula_ps_no <- as.formula("nSES ~ 1")
formula_ps <- as.formula("nSES ~ age+Diabetes+hdl+totchol+sbp+gender+race+site")
...
formula_ps <- as.formula("nRS ~ age+gender+Diabetes+hdl+totchol+sbp")
